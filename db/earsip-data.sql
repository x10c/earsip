...
-- m_subdiv
--
insert into m_subdiv (div_id, subdiv_kode, subdiv_name, subdiv_leader)
values (1, 'IT', 'Subdivisi IT', '');

--
-- m_user
--
insert into m_user (user_id, subdiv_id, user_nip, user_name, user_psw)
values (1, 1, '1', 'Administrator', 'earsip');
